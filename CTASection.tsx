        ...
        <section className="py-32 relative overflow-hidden">
            ...
            <div className="relative z-20 max-w-4xl mx-auto px-4 text-center">
                <h2 className="text-4xl md:text-6xl font-black text-white mb-8 tracking-tight">
                    Bereit für dein <br/>
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-cyan-200 to-cyan-500">nächstes Level?</span>
                </h2>
                <p className="text-xl text-slate-300 mb-12 font-light max-w-2xl mx-auto leading-relaxed">
                    Hör auf, Leads zu verbrennen und dich mit Routineaufgaben zu quälen. 
                    Lass uns dein Business in 30 Minuten auditieren.
                </p>
